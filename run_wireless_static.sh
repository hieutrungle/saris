...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_sac_torchcompile.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --name "L_shape_static" --env_id "wireless-sigmap-v0" --seed 22 --num_envs 2 --total_timesteps 20 --batch_size 4 --learning_starts 6 --wandb "offline" --warmup_steps 4 --ep_len 5 --load_replay_buffer "/home/hieule/research/saris/local_assets/replay_buffers/SAC__L_shape_static__wireless-sigmap-v0__68763e89"
