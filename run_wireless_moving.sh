...
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_sac_torchcompile.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "wireless-moving-v0" --num_envs 1 --total_timesteps 80 --ep_len 75 --batch_size 4
