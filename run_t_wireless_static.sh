...
# Configuration files
SIONNA_CONFIG_FILE=${SOURCE_DIR}/configs/sionna_T_multi_users.yaml
...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_t_hallway.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --name "T_shape_static" --env_id "wireless-sigmap-v0" --seed 1 --wandb "offline" --num_envs 2 --learning_starts 2 --batch_size 3
