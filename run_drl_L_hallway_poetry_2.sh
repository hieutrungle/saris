...
# DRL run
##############################
poetry run main --command train -dcfg ${DRL_CONFIG_FILE} -scfg ${SIONNA_CONFIG_FILE} -v --resume --seed 1

export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_2
poetry run main --command eval -dcfg ${DRL_CONFIG_FILE} -scfg ${SIONNA_CONFIG_FILE} -v --seed 1