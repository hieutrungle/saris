...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_marl.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "shared-ap-v0" --group "SAC_Shared_AP" --name "random_ue_pos" --ff_dim 128 --save_interval 300 --learning_starts 0 --total_timesteps 15 --n_runs 0 --init_learning_starts 10 --ep_len 8 --batch_size 4 --num_envs 1 --eval_ep_len 8 --wandb "offline" --seed 22 --no_eval True --wandb "offline"
