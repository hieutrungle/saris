...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_sac.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "single-room-v0" --group "SAC_ROOM_Static" --name "ls_256_NN_small_step" --ff_dim 256 --save_interval 300 --learning_starts 0
