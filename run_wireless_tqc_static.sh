...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_tqc.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "wireless-sigmap-v0" 
# --seed 22 --num_envs 2 --total_timesteps 15 --batch_size 4 --learning_starts 4 --warmup_steps 5 --ep_len 3 --save_interval 25 --eval_ep_len 10 
# --wandb "offline" 