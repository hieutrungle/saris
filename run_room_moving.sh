...
##############################
export OPTIX_CACHE_PATH=${TMP_DIR}/optix_cache_1
python ./saris/run_sac.py --sionna_config_file ${SIONNA_CONFIG_FILE} --verbose True --env_id "single-room-moving-v0" --group "SAC_ROOM_Moving" --name "ls_128_NN" --ff_dim 128 --save_interval 300 --learning_starts 0 --total_timesteps 1800 --n_runs 20
